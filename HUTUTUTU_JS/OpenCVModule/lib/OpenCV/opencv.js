...
console.info('isWechat:', isWechat, WXWebAssembly);
  ...
  var cv = (() => {
    ...
    return (
      function (cv) {
        ...
        console.info("wasm.br:", wasmBinaryFile);
        ...
        function createWasm() {
          ...
          function instantiateArrayBuffer(receiver) {
            ...
            return getBinaryPromise().then(function (binary) {
              return WXWebAssembly.instantiateStreaming(binary, info)
          ...
          function instantiateAsync() {
            if (isWechat) {
              ...
              if (!wasmBinary && typeof WXWebAssembly.instantiateStreaming == "function" && !isDataURI(wasmBinaryFile) && !isFileURI(wasmBinaryFile) && !ENVIRONMENT_IS_NODE && typeof fetch == "function") {
                return fetch(wasmBinaryFile, {
                  credentials: "same-origin"
                }).then(function (response) {
        ...
        var ___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = function () {
          return (___cxa_is_pointer_type = Module["___cxa_is_pointer_type"] = Module["asm"]["ga"]).apply(null, arguments)
        };
